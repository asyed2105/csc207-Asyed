...
<br>
- On line 22 we create our ArrayList and give it an initial size of 10. -> NOTE WE ARE USING KEYWORD "**new**"
          - In Java, the **new** keyword is used to create objects, but it is **NOT**__ needed for primitive data types or certain built-in types that don't require object instantiation. 
